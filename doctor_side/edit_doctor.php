...
while ($row = mysqli_fetch_array($result)) 
{
    ...
    $specialty2 = $row['specialty2'];
    $specialty3 = $row['specialty3'];
}
...
if($_POST)
{
    ...
    `description`='$Description',`contact`='$Contact',`clinic_address`='$address',`specialty`='$specialty', `specialty2`='$specialty2', `specialty3`='$specialty3' WHERE doctor_id = '".$_GET['id']."'";

    $result = mysqli_query($conn,$sql1);

    if ($result) {
        echo "<script> alert('Updated Successfully!'); location.replace('doctor_dashboard.php') </script>";
    }
    else {
...
<div class = "container my-5">
    ...
    <form style = "font-family: monospace;" method="POST" action = "">
            ...
            <div class = "row mb-3">
                <label class = "col-sm-3 col-form-label">Sub-Specialization:</label>
                <div class = "col-sm-6">
                <select name="specialty2" id="" class = "form-control">
                    <option> <?php echo $specialty2?></option>
                <?php
                        $sql_list = "SELECT * FROM doctor_specialty ORDER BY doctor_specialty.Specialty_Title ASC;";
                        $result = mysqli_query($conn,$sql_list);
            ...
            <div class = "row mb-3">
                ...
                <select name="specialty3" id="" class = "form-control">
                    <option> <?php echo $specialty3?></option>
                <?php
                        $sql_list = "SELECT * FROM doctor_specialty ORDER BY doctor_specialty.Specialty_Title ASC;";
                        $result = mysqli_query($conn,$sql_list);
            ...
            <div class = "row mb-3">
                ...
                <div class = "col-sm-3 d-grid">
                    <a class = "btn btn-outline-primary" href="doctor_dashboard.php" role = "button">CANCEL</a>
                </div>
            </div>
        </form>
    </div>
