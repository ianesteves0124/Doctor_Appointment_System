...
<div class="about">
    <h1>Top Specialization | About Dental Care</h1>
</div>
<div>
...
<div class="titlelist" style="text-align:center;"><h1>DOCTORS LIST</h1></div>
        ...
        $sql = "SELECT *
                FROM `doctor`
                WHERE `specialty` = 'Dental Care'
                OR `specialty2` = 'Dental Care'
                OR `specialty3` = 'Dental Care'
                AND is_disabled = 0;";
                                    ...
                                    <form action="booking.php" method = "POST">
                                        ...
                                        <h3>Selected Doctor:<p><?php echo $name?></p></h3>
                                         ...
                                         <h3>Gender:</h3>
                                          ...
                                          <h3>Email Address:</h3>
                                                    <input type="email" name="patient_email" value = "<?php echo $useremail?>" required><br>
                                          <h3>Contact Number:</h3>
