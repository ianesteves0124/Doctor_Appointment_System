...
--
-- Host: localhost
-- Generation Time: Jul 22, 2023 at 09:38 AM
...
--
-- Database: `id20335682_appointment_system`
--
...
CREATE TABLE `admin` (
  ...
  `admin_password` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
...
CREATE TABLE `booking` (
  ...
  `patient_name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `patient_contact` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `doctor` (
  ...
  `doctor_name` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `doctor_email` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  ...
  `specialty` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `specialty2` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `specialty3` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `doctor_specialty` (
  `ID` int(2) NOT NULL,
  `Specialty_Title` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `patient` (
  ...
  `patient_dob` date DEFAULT NULL,
  `verification_code` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
