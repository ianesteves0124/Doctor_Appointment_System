...
<head>
    ...
    <link rel="stylesheet" href="sechome_page.css">
    <title>Doctor Appointment System secondhome page</title>
</head>
<body>

<div class="bg-image"> 
<div class ="first_tab">
    <h1 class ="f_start_line">"We are committed to your Health, Caring for Life."</h1>
    <!-- <h2 class = "f_second_line">You won't forget ever again your Doctor's Appointments!</h2> -->
    <button class = "nxtbtn" onclick = "location.href = 'thirdhome_page.php'"><span>View the various professionals and services we offer</span></button>

    <!-- <div class="center">
  <div class="pagination">
  <a href="#">&laquo;</a>
  <a href="home_page.php">1</a>
  <a href="sechome_page.php" class="active">2</a>
...
<div class="pagination">
        ...
        <ul class="pagination--link">
            ...
            <li> <a href="sechome_page.php" class="active"> 2 </a></li>
